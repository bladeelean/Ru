...
export const PortfolioMobile = () => {
    ...
    const mobileData = [
        ...
        {
                image: ["/images/mobile/4.png","/images/mobile/51.png", "/images/mobile/5.png", "/images/mobile/6.png", "/images/mobile/7.png","/images/mobile/50.png", "/images/mobile/28.png","/images/mobile/49.png"],
